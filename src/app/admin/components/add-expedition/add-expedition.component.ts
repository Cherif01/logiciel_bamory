...
import { InitExpeditionComponent } from '../../_dialogs/init-expedition/init-expedition.component';
...
export class AddExpeditionComponent {
  title: string = 'Gestion des Expéditions';
  ...
  dialogInitExpedition() {
      this.dialog
        .open(InitExpeditionComponent, {
          width: '450px',
        })
        .afterClosed()
        .subscribe((data: any) => {
