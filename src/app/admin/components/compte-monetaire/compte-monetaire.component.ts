...
import { AddAccountComponent } from '../../_dialogs/add-account/add-account.component';

@Component({
  selector: 'app-compte-monetaire',
  imports: [SHARED_IMPORTS],
  templateUrl: './compte-monetaire.component.html',
  styleUrl: './compte-monetaire.component.scss'
})
export class CompteMonetaireComponent {
  title: string = 'Gestion des Comptes';
  ...
  dialogAddAccount() {
      this.dialog
        ...
        .subscribe((data: any) => {
          // console.log(data);
          this.service
            .create('addAccount', 'create.php', convertObjectInFormData(data))
            .subscribe({
              next: (response: any) => {
